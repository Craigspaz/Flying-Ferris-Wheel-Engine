...
public class Projectile extends Entity
{
	...
	public void update(ArrayList<RectangleBox> colliders)
	{
		...
		particles.add(new Particle(new Vector2f(position.x, position.y), new Vector2f(16, 16), Textures.particles, 14, 3, true, new Vector2f(16, 16), new Vector2f(256, 128), false, new Vector2f(velocity.x / 2, velocity.y / 2), 5f, 5f, .5f));
		particles.add(new Particle(new Vector2f(position.x, position.y), new Vector2f(16, 16), Textures.particles, 10, 4, true, new Vector2f(16, 16), new Vector2f(256, 128), false, new Vector2f(velocity.x / 2, velocity.y / 2), 5f, 5f, .75f));
		particles.add(new Particle(new Vector2f(position.x, position.y), new Vector2f(16, 16), Textures.particles, 10, 5, true, new Vector2f(16, 16), new Vector2f(256, 128), false, new Vector2f(velocity.x / 2, velocity.y / 2), 5f, 5f, .75f));
		particles.add(new Particle(new Vector2f(position.x, position.y), new Vector2f(16, 16), Textures.particles, 10, 6, true, new Vector2f(16, 16), new Vector2f(256, 128), false, new Vector2f(velocity.x / 2, velocity.y / 2), 5f, 5f, .75f));
		particles.add(new Particle(new Vector2f(position.x, position.y), new Vector2f(16, 16), Textures.particles, 10, 7, true, new Vector2f(16, 16), new Vector2f(256, 128), false, new Vector2f(velocity.x / 2, velocity.y / 2), 5f, 5f, .75f));
	}
